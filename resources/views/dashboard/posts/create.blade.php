...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
    ...
    <form action="/dashboard/posts" method="post" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            <label for="formFile" class="form-label">post gamber</label>
        ...
        <div class="mb-3">
            ...
            <div class="form-floating">
                <textarea name="body" class="form-control @error('body') is-invalid @enderror" placeholder="Leave a comment here" id="floatingTextarea">{{ old('body') }}</textarea>
